// 🎨 RASCUNHO V3: Nova Hero Section Híbrida B2B + B2C
// COM LOGO XZENPRESS NO TOPO + LOGO NO CENTRO
// Para ser inserida no HomePage.tsx ANTES do banner atual

{/* ========================================
    NOVA HERO SECTION V3 - DUAL MESSAGE B2B+B2C
    COM LOGO XZENPRESS (TOPO E CENTRO)
    ======================================== */}
...
<section className="relative overflow-hidden bg-gradient-to-br from-purple-50 via-white to-cyan-50 py-16">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ========== LOGO XZENPRESS NO TOPO ========== */}
        <div className="flex justify-center mb-8">
            <div className="relative">
                {/* Glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-green-400 to-blue-400 rounded-full blur-2xl opacity-30 animate-pulse"></div>

                {/* Logo XZenPress */}
                <div className="relative w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-cyan-300 shadow-2xl bg-white p-4">
                    <img
                        src="/Logo Xzenpress oficial.png"
                        alt="XZenPress - Plataforma de Bem-estar Integrativo"
        ...
        <div className="relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="relative">
                    ...
                    {/* Logo Container */}
                    <div className="relative w-24 h-24 bg-white rounded-full shadow-2xl border-4 border-white flex items-center justify-center p-2">
                        <img
                            src="/Logo Xzenpress oficial.png"
                            alt="XZenPress Logo"
                            className="w-full h-full object-contain"
...
{/* ========================================
    FIM DA NOVA HERO SECTION V3
    
    ESTRUTURA FINAL:
    1. ✅ Logo XZenPress (topo, centralizado, 192x192px)
    2. ✅ Headline "Sua Biologia é um Milagre"
    3. ✅ Cards lado a lado (B2C | B2B)
    4. ✅ PEDRINHAS mantidas (🌿☯️🧘 | 🛡️💰⚡)
    5. ✅ Logo XZenPress no centro (entre os cards)
    6. ✅ Trust badges (rodapé)
