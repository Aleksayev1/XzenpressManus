-- Script para popular traduções do post principal
-- Execute este script no SQL Editor do Supabase APÓS criar as colunas

-- Atualizando: 5 Pontos de Acupressão (slug: 5-pontos-acupressao-estresse-diario)
...
WHERE slug = '5-pontos-acupressao-estresse-diario' OR slug = '5-pontos-acupressao';
