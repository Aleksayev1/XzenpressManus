    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-16 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">{t('personalization.restricted.title')}</h2>
          <p className="text-gray-600 mb-6">{t('personalization.restricted.subtitle')}</p>
          <button
            onClick={() => onPageChange('login')}
            className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors"
          >
            {t('personalization.restricted.login')}
          </button>
        </div>
      </div>
    );
