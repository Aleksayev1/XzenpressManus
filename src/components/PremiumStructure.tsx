  ...
  if (user?.isPremium) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 pt-16">
        ...
        {/* Research & Science Banner - XZenLab */}
        <div className="mt-16 bg-gradient-to-r from-cyan-900 to-blue-900 rounded-3xl shadow-2xl p-8 md:p-12 border border-cyan-500/30 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center space-x-2 bg-cyan-500/10 border border-cyan-400/30 rounded-full px-4 py-1 mb-4">
                <span className="animate-pulse text-cyan-400">●</span>
                <span className="text-cyan-200 text-sm font-medium tracking-wide">XZENLAB RESEARCH</span>
              </div>

              <h2 className="text-3xl font-bold text-white mb-4">
                Contribuição para Ciência Real
              </h2>

              <p className="text-cyan-100 text-lg leading-relaxed mb-6">
                Sua prática gera valor científico. Seus dados anonimizados ajudam a construir o primeiro grande banco de dados de <strong className="text-white">'Real-World Evidence' (RWE)</strong>, validando correlações avançadas como a conexão <span className="text-cyan-300 font-semibold">Nervo Vago (X) ↔ Fígado</span> e a eficácia da YNSA em escala global.
              </p>

              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                <div className="flex items-center space-x-2 bg-black/20 rounded-lg px-4 py-2">
                  <Brain className="w-5 h-5 text-purple-400" />
                  <span className="text-gray-300 text-sm">Neurociência Aplicada</span>
                </div>
                <div className="flex items-center space-x-2 bg-black/20 rounded-lg px-4 py-2">
                  <Shield className="w-5 h-5 text-green-400" />
                  <span className="text-gray-300 text-sm">Dados Anonimizados</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-shrink-0">
              ...
              <div className="w-48 h-48 md:w-64 md:h-64 bg-cyan-500/5 rounded-full flex items-center justify-center border-4 border-cyan-500/20 relative">
                <div className="absolute inset-0 rounded-full border-t-4 border-cyan-400 animate-spin-slow opacity-50"></div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-white mb-1">Big Data</div>
                  <div className="text-cyan-400 text-xs md:text-sm uppercase tracking-widest">Clinical Validation</div>
                </div>
              </div>
            </div>
          </div>
