...
export const TutorialModal: React.FC<TutorialModalProps> = ({
  ...
  const tutorialSteps: TutorialStep[] = [
    ...
    {
      id: 7,
      title: 'Sessão Mestra (Tríade Unificada)',
      description: 'Uma experiência imersiva que integra Acupressão, Respiração 4-7-8 e Cromoterapia em um fluxo contínuo guiado',
      emoji: '🧘',
      icon: <Activity className="w-8 h-8 text-white" />,
      action: {
        text: 'Iniciar Sessão Mestra',
        page: 'sessao-mestra',
      },
      tips: [
        'Avaliação prévia e posterior do estado emocional (Coherence Score)',
        'Integra os pontos mais eficazes em um único protocolo imersivo',
        'Seus resultados são capturados pela ZenMemory para personalizar as terapias',
      ],
      gradient: 'from-fuchsia-500 via-purple-600 to-indigo-700',
      accentColor: '#9333ea',
      badgeText: 'Integração',
    },
    {
      id: 8,
      title: 'ZenMemory — Memória Evolutiva',
      description: 'O Self Oracle aprende continuamente com seus relatos e constrói um perfil integrativo único (físico, mental e espiritual)',
      emoji: '🧠',
      icon: <Brain className="w-8 h-8 text-white" />,
      tips: [
        'A IA extrai padrões emocionais enquanto você conversa livremente',
        'As memórias candidatas aparecem para a sua validação: você aprova (👍) ou rejeita (👎)',
        'Quanto mais validado, mais profunda se torna a sabedoria da IA sobre você',
        'Cada sessão concluída gera rastros episódicos para a evolução contínua',
      ],
    ...
    },
    {
      ...
      tips: [
        ...
        '4. Conclua seus ciclos através da Sessão Mestra guiada',
        '5. Confirme e molde a sua ZenMemory (Painel de Recomendações)',
        '6. Acompanhe sua evolução biológica e energética no Dashboard',
      ],
