  ...
  const tutorialSteps: TutorialStep[] = [
    {
      ...
      description: 'Sua plataforma completa de medicina integrativa — unindo milênios de sabedoria com ciência moderna e Inteligência Artificial',
      emoji: '🌟',
      icon: <Heart className="w-8 h-8 text-white" />,
      tips: [
        'Combine MTC, Craniopuntura YNSA e respiração científica em um só lugar',
        'A IA Self Oracle mapeia seus bloqueios emocionais e cria protocolos personalizados',
        'Todas as ferramentas básicas são gratuitas e disponíveis 24/7',
        'Cada sessão é registrada pela ZenMemory para evoluir continuamente com você',
      ],
    ...
    {
      id: 7,
      title: 'ZenFlow — Qi Gong Personalizado',
      description: 'Sequências de movimento e respiração do Qi Gong adaptadas ao seu elemento e emoção atual, integradas à Sessão Mestra',
      emoji: '🌊',
      icon: <Activity className="w-8 h-8 text-white" />,
      tips: [
        'Cada emoção tem um exercício ZenFlow específico prescrito pela IA',
    ...
    {
      id: 8,
      title: 'Evolução & ZenMemory',
      description: 'Acompanhe seu progresso biológico e emocional ao longo do tempo — a IA aprende e personaliza cada vez mais',
      emoji: '📊',
      icon: <Brain className="w-8 h-8 text-white" />,
      action: {
      ...
      tips: [
        '📈 Gráfico de evolução do bem-estar: veja sua melhora semana a semana',
        '🧠 ZenMemory extrai padrões emocionais enquanto você conversa livremente',
        '👍 Valide ou rejeite memórias candidatas — você controla o que a IA aprende',
        '🏆 Coherence Score acumulado: métrica objetiva de equilíbrio corpo-mente',
        '📅 Histórico de sessões completo para acompanhar sua jornada terapêutica',
      ],
    ...
    {
      id: 9,
      title: 'Benefícios Corporativos & Premium',
      description: 'Ative seu acesso completo via plano corporativo, cartão parceiro ou assinatura direta',
      emoji: '👑',
      icon: <Crown className="w-8 h-8 text-white" />,
      action: {
        text: 'Conhecer Planos Premium',
        page: 'premium',
      },
      tips: [
        '🏢 Benefício corporativo? Ative seu plano gratuito via empresa parceira',
        '💳 Cartão MasterClin e outras redes — verifique se você já tem acesso premium!',
        '🎵 Spotify Premium: conecte e amplie sua biblioteca de sons terapêuticos',
        '⭐ 11 pontos especializados + consulta WhatsApp + biblioteca completa de 50+ sons',
        '📊 Progresso e evolução ilimitados com IA personalizada',
      ],
    ...
    },
    {
      ...
      tips: [
        '1. 🔮 Descreva como se sente ao Self Oracle → receba seu diagnóstico',
        '2. ✨ Inicie sua Sessão Mestra personalizada com o protocolo prescrito',
        '3. 🎵 A IA escolhe a frequência sonora correta para o seu Elemento MTC',
        '4. 🌊 Complete o ZenFlow guiado ao final de cada sessão',
        '5. 📊 Confirme suas memórias e acompanhe sua evolução no Dashboard',
        '6. ⚡ Ou experimente a Sessão Integrativa rápida para sentir o método agora!',
      ],
