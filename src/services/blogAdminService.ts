...
export class BlogAdminService {
  ...
  static async updatePost(postId: string, updates: Partial<BlogPost>): Promise<BlogPost> {
    ...
    // Map only the fields we want to update, converting to snake_case
    ...
    if (updates.authorEmail !== undefined) updateData.author_email = updates.authorEmail;
    // Convert imageUrl (camelCase) to image_url (snake_case)
